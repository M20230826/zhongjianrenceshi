...
// 0 - 不支持UCOS系统
// 1 - 支持UCOS系统
#define SYSTEM_SUPPORT_OS 0 // 配置系统是否支持UCOS
...
// 外部变量声明
extern u8 Mode, BLUETOOTH_Mode, ELE_Line_Patrol_Mode, CCD_Line_Patrol_Mode, PS2_Mode; // 小车模式
...
extern int Motor_A, Motor_B, Servo, Target_A, Target_B; // 电机和舵机控制
extern int Voltage; // 电压
extern float Show_Data_Mb; // 显示数据
extern u8 delay_50, delay_flag; // 延时标志
extern float Velocity_KP, Velocity_KI, Velocity_KD, Velocity_KJ; // PID参数
extern int PS2_LX, PS2_LY, PS2_RX, PS2_RY, PS2_KEY; // PS2手柄数据
extern u16 ADV[128]; // CCD数据
extern u8 CCD_Zhongzhi, CCD_Yuzhi, PID_Send, Flash_Send, APP_RX, APP_Flag, PS2_Flag; // CCD和APP相关标志
